...
<?php     
  ...
  if (isset($_POST['signin']))
    ...
    $pass=$_POST['password'];
    $password=md5($pass);
    $qry="select * from leapscode_subadmin where Email='$email' and Password='$password'";
 ...
 <div class="row">
  ...
  <div class="col-md-4 col-sm-4 col-xs-12">
   ...
   <div class="form-group">
    <h5 class="text-muted" class=font-weight-light" style="color: #000000">Sub-Admin Login</h5>
  ...
  <br>
  <button type="submit" class="btn btn-primary btn-block" name="signin">Log in</button><br>
