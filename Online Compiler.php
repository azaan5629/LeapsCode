...
<html>
<head>
	<title>LeapsCode Compiler</title>
	  <!-- Favicons -->
 ...
 <nav class="navbar" id="header1">
	...
	<div class="logo mr-auto">
		...
		<nav class="nav-menu d-none d-lg-block">
        	<ul align="right">
				<button class="btn brn-primary"><a href="index.php">Back to Home</a></button>
			</ul>
        </nav><!-- .nav-menu -->
  </nav>
		...
		<div class="main-content">
			<form action="Online Compiler.php" method="post" role="form">
				...
				<div class="row">
					<div class="col-sm-9">
						...
						?>
					<textarea rows="40" cols="170" name="program" class="program" id="code" value= <?php if (isset($code)){?>
                    <spam class="text-danger"> <?php echo $code; }?></textarea>
						<?php 
					...
					<div class="col-sm-3 side-content">
						...
						<div class="form-group">
							...
							<br>
							<br>
							<span value= <?php if (isset($output)){?>
                    <span class="text-success"> <?php echo $output; }?></span>
                    	<br>
							<span value= <?php if (isset($error_msg)){?>
                    <spamnclass="text-danger"> <?php echo $error_msg; }?></span>
						</div>
					</div>
				</div>
			</form>
