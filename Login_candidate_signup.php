...
<?php     
  ...
  if (isset($_POST['signin']))
    ...
    $pass=$_POST['password'];
    $password=md5($pass);
    $qry="select * from candidate where Email='$email' and Password='$password'";
    ...
    else
    {
      ...
      header("location: Edit-Contestant-details.php?token=".$token."&dur=".$dur."&tna=".$tna);
    }
  }
...
<div class="container-fluid bg" >
 <div class="row">
  ...
  <div class="col-md-4 col-sm-4 col-xs-12">
   ...
   <center><img style="margin-left: 168px"  src="assets/img/Titleimage.png" alt=""  height="80px" width="80px  class="img-fluid"></center>
   <br>
    <span id="passspan" class="text-success" class="h4">Congratulations, you have successfully signed up!</span>
  ...
  <br>
  <center><button type="submit" class="btn btn-primary btn-block" name="signin">Log in</button></center>
  <?php if (isset($error_msg)){?>
                <spam class="text-danger"> <?php echo $error_msg;} ?></spam>
                <br>
  <center><a href="Recover-account.php">Forgot password?</a></center>
</form> 
